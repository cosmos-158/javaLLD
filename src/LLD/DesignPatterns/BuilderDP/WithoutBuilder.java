package LLD.DesignPatterns.BuilderDP;
...
class HttpRequest{
    ...
    // Constructor with only required parameter (1-args)
...
public class WithoutBuilder {
    public static void main(String[] args) {
        ...
        // The problem: what if we forgot to set an important field? -> this would lead to inconsistent state problem.
        request4.execute();
    }
}
