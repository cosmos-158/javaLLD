...
/*
    Strategy Design Pattern: (The solution to inheritance is not more inheritance.)
     ...
     Facade Design Pattern: (Intent is to hide the complexity of subsystem from client).
        ...
        Definition: Facade pattern provides a simplified, unified interface to a set of Complex subsystem. It hides the
                    complexity of the system and exposes only what is necessary.
